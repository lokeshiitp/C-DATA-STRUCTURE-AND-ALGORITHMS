...
plt.ylabel('Count')
plt.title('Bar Chart of Count for soil type')
...
# Assuming 'new_instance' contains features for the new instance
#new_instance = [['LIQUID_LIMIT','PLASTIC_LIMIT','PLASTICITY_INDEX','SPEC_GRAVITY','MAX_LAB_DRY_DENSITY','OPTIMUM_LAB_MOISTURE','RESILIENT_MODULUS_K1','RESILIENT_MODULUS_K2','RESILIENT_MODULUS_K3','HYDRAULIC_CONDUCTIVITY']]  # Replace with actual feature values
predicted_value = svm_model.predict(X)
print("Predicted value for new instance:", predicted_value)
